...
import type { QuickLedgerStats } from '../../domain/StaffLedgerData';

interface StaffLedgerStatsGridProps {
  stats: QuickLedgerStats;
}

export function StaffLedgerStatsGrid({ stats }: StaffLedgerStatsGridProps) {
  return (
