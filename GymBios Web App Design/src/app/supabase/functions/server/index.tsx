...
app.post("/make-server-0a04502f/auth/signin", async (c) => {
  try {
    ...
    // Demo account fallback for development
    if ((email === 'admin@gymbios.com' && password === 'admin123') ||
        (email === 'admin@gymbios.com' && password === 'password123')) {
      ...
      await kv.set(`user_profile_${demoUser.id}`, {
        id: demoUser.id,
