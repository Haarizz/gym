...
// Stable formatter references — defined at module scope to prevent new function
// instances on every render, which causes Recharts to generate duplicate child keys.
const currencyFormatter = (value: any) => [`${Number(value).toLocaleString()} AED`, ''];
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={260}>
              <LineChart data={monthlyTrends}>
                ...
                <Line key="income" type="monotone" dataKey="income" stroke="#10b981" strokeWidth={3} name="Income" dot={false} />
                <Line key="expenses" type="monotone" dataKey="expenses" stroke="#ef4444" strokeWidth={3} name="Expenses" dot={false} />
                <Line key="profit" type="monotone" dataKey="profit" stroke="#3b82f6" strokeWidth={3} name="Profit" dot={false} />
              </LineChart>
            </ResponsiveContainer>
            <div className="flex items-center justify-center gap-6 mt-3 text-sm">
              <span className="flex items-center gap-1.5"><span className="inline-block w-4 h-0.5 bg-[#10b981] rounded" />Income</span>
              <span className="flex items-center gap-1.5"><span className="inline-block w-4 h-0.5 bg-[#ef4444] rounded" />Expenses</span>
              <span className="flex items-center gap-1.5"><span className="inline-block w-4 h-0.5 bg-[#3b82f6] rounded" />Profit</span>
            </div>
          </CardContent>
        </Card>
