        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
            <CardHeader className="space-y-2 pb-6">
              ...
              <Alert className="border-[#327F74]/20 bg-[#327F74]/5">
                <Shield className="h-4 w-4 text-[#327F74]" />
                <AlertDescription className="text-gray-700">
                  <div className="font-semibold mb-1">Demo Credentials</div>
                  <div className="text-sm space-y-0.5">
                    <div><span className="font-medium">Email:</span> admin@gymbios.com</div>
                    <div><span className="font-medium">Password:</span> Gbu@bios</div>
                  </div>
                </AlertDescription>
              </Alert>
            </CardHeader>
