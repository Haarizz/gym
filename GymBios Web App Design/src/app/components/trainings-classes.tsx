  ...
  const renderCalendarView = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        {/* Calendar Grid */}
        <div className="bg-white rounded-xl shadow-sm border overflow-hidden" style={{ borderColor: '#2B7A7820' }}>
          {/* Day Headers */}
          <div className="grid grid-cols-8" style={{ background: 'linear-gradient(135deg, #2B7A78 0%, #2B7A78 100%)' }}>
