...
export function Leads() {
  ...
  const [leadFormData, setLeadFormData] = useState<any>(null);
  ...
  const handlePhotoUpload = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setLeadPhoto(reader.result as string);
        setPhotoFileName(file.name);
        toast.success('Photo Uploaded', {
          description: 'Lead photo has been uploaded successfully.',
        });
      };
  ...
  const handleRemovePhoto = useCallback(() => {
    ...
    toast.info('Photo Removed', {
      description: 'Lead photo has been removed.',
    });
  }, []);

  // Handle save lead - opens grant access dialog
  const handleSaveLead = useCallback(() => {
    // Validate required fields
    if (!leadPhoto) {
      toast.error('Photo Required', {
        description: 'Please capture or upload a photo of the visitor for access control.',
      });
      return;
    }
  ...
  }, [leadPhoto, visitDate, photoFileName]);
  ...
  const handleGrantAccess = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      toast.success('Access Granted Successfully!', {
        description: `Visitor has been granted gym access for ${new Date(visitDate).toLocaleDateString()}. Face recognition configured.`,
        duration: 5000,
      });
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <Label>Visitor Photo (For Access Control)</Label>
              ...
              {!leadPhoto ? (
                <div className="flex gap-2">
                  <Button
                    type="button"
                    variant="outline"
                    className="flex-1 bg-[#2B7A78] text-white hover:bg-[#236763]"
                ...
                <div className="relative border-2 border-[#2B7A78] rounded-lg p-3 bg-gray-50">
                  <img 
                    src={leadPhoto} 
                    alt="Visitor photo" 
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-muted-foreground mt-1 mb-2">
                Date when the visitor will access the gym
              </p>
              <Input 
                type="date" 
                className="mt-1" 
          ...
          <div className="space-y-4 mt-4">
            <Alert className="border-[#2B7A78] bg-[#2B7A78]/5">
              ...
              <AlertDescription className="text-sm">
                This will configure the face access control system to grant gym entry for the visitor on the specified visit date.
              </AlertDescription>
            </Alert>
