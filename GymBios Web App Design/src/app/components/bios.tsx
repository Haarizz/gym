...
import { KPIReportDialog } from "./kpi-report-dialog";
import { ExecutiveDashboardDialog } from "./executive-dashboard-dialog";
import { BusinessIntelligenceDialog } from "./business-intelligence-dialog";
import { PerformanceMetricsDialog } from "./performance-metrics-dialog";
import { PredictiveAnalyticsDialog } from "./predictive-analytics-dialog";
import { RevenueAnalyticsDialog } from "./revenue-analytics-dialog";
import { MemberAnalyticsDialog } from "./member-analytics-dialog";
import { OperationalReportsDialog } from "./operational-reports-dialog";
import { BenchmarkingDialog } from "./benchmarking-dialog";
import { BIEngineDashboard } from "./bi-engine-dashboard";
...
import { BIEngineWrapper } from "./bi-engine-wrapper";
import {
  Brain,
  Monitor,
  Gauge,
...
export function BiOS() {
  const [showKPIReport, setShowKPIReport] = React.useState(false);
  const [showExecutiveDashboard, setShowExecutiveDashboard] = React.useState(false);
  ...
  const [showMemberAnalytics, setShowMemberAnalytics] = React.useState(false);
  const [showOperationalReports, setShowOperationalReports] = React.useState(false);
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowExecutiveDashboard(true)}>View Details</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowKPIReport(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowBusinessIntelligence(true)}>Analyze</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowBusinessIntelligence(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowPerformanceMetrics(true)}>Monitor</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowPerformanceMetrics(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowPredictiveAnalytics(true)}>Predict</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowPredictiveAnalytics(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowRevenueAnalytics(true)}>Analyze</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowRevenueAnalytics(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowMemberAnalytics(true)}>Segment</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowMemberAnalytics(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowOperationalReports(true)}>Generate</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowOperationalReports(true)}>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setShowBenchmarking(true)}>Compare</Button>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between pt-2">
                <Button variant="ghost" size="sm" onClick={() => setShowBenchmarking(true)}>
                  <BarChart3 className="h-4 w-4 mr-1" />
                  Full Report
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowBenchmarking(true)}>
      ...
      {/* Executive Dashboard Dialog */}
      <ExecutiveDashboardDialog
        open={showExecutiveDashboard}
        onOpenChange={setShowExecutiveDashboard}
        topKPIs={topKPIs}
        performanceMetrics={performanceMetrics}
        revenueBySource={revenueBySource}
        revenueData={revenueData}
      ...
      <BusinessIntelligenceDialog
        open={showBusinessIntelligence}
        onOpenChange={setShowBusinessIntelligence}
        topKPIs={topKPIs}
        performanceMetrics={performanceMetrics}
        revenueBySource={revenueBySource}
        revenueData={revenueData}
      ...
      {/* Predictive Analytics Dialog */}
      <PredictiveAnalyticsDialog
        open={showPredictiveAnalytics}
        onOpenChange={setShowPredictiveAnalytics}
      ...
      <RevenueAnalyticsDialog
        open={showRevenueAnalytics}
        onOpenChange={setShowRevenueAnalytics}
        revenueBySource={revenueBySource}
        revenueData={revenueData}
        formatCurrency={formatCurrency}
        getCurrentPeriod={getCurrentPeriod}
      ...
      <MemberAnalyticsDialog
        open={showMemberAnalytics}
        onOpenChange={setShowMemberAnalytics}
        memberAnalytics={memberAnalytics}
        formatCurrency={formatCurrency}
        getCurrentPeriod={getCurrentPeriod}
      />

      {/* Operational Reports Dialog */}
      <OperationalReportsDialog
        open={showOperationalReports}
        onOpenChange={setShowOperationalReports}
        recentReports={recentReports}
        formatCurrency={formatCurrency}
        getCurrentPeriod={getCurrentPeriod}
      />
      ...
      {/* Benchmarking Dialog */}
      <BenchmarkingDialog
        open={showBenchmarking}
        onOpenChange={setShowBenchmarking}
        benchmarkData={benchmarkData}
        formatCurrency={formatCurrency}
        getCurrentPeriod={getCurrentPeriod}
      />
